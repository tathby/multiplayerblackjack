...
public class FlexibleColorPicker : MonoBehaviour {
    ...
    */
    ...
    public bool IgnoreNextUpdate = false;
    ...
    public Color color {
        ...
        set {
            ...
            else onColorChange.Invoke(value);
        }
    }
    ...
    /// </summary>
    public void SetColor(Color color, bool ignoreUpdate = false) {
        IgnoreNextUpdate = ignoreUpdate;
        this.color = color;
    }
